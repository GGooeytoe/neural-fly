...
epochs=100
model,scaler_X,scaler_label,outfolder=gemini_train_pi_groups.train_dimensional_model(save_folder_prefix=f"train_dimensional{epochs}epochs_intel_and_save",data_folder="./data/training-transfer",epochs=epochs)
pred,rmse,percent=gemini_train_pi_groups.test_dimensional_model_on_dataset(model,scaler_X,scaler_label,"./data/training/")
